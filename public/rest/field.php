...
switch ($req_type) {
    ...
    case 'POST':
        ...
        "entryId" => "name",
        "table" => "p_field",
        "columns" => array( "description", "bit_offset", "size_bit", "access", "modified_write_values", "read_action", "is_Enum", "enum_name", "enum_usage_right"),
        "link_id" => "reg_id",
    ...
    case 'PUT':
        $opts = array(
        "filters" => array( "id" ),
        "sql" => "SELECT id, name, description, bit_offset, size_bit, access, modified_write_values, read_action, is_Enum, enum_name, enum_usage_right FROM p_field",
        "table" => "p_field",
        "columns" => array( "name", "description", "bit_offset", "size_bit", "access", "modified_write_values", "read_action", "is_Enum", "enum_name", "enum_usage_right"),
